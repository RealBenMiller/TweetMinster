...
const parliamentTwitterSearch = 'http://lda.data.parliament.uk/members/';
...
const postCodeSearch = function() {
  ...
  $.ajax({url: mpConsituencySearchURL, datatype:"jsonp", success: function(data){
    ...
    $.ajax({url: mpTwitterSearchURL, datatype:"jsonp", success: function(data){
      ...
      twitterButton = '<div class="twitterButton"><a href="https://twitter.com/intent/tweet?screen_name=' + twitterName + '&hashtags=TweetMyMP"><i class="fab fa-twitter"></i>  Tweet to ' + twitterhandle + '</a></div>';
